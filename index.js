...
const vcard = 'BEGIN:VCARD\n' // JAN MUDOU
            + 'VERSION:3.0\n' // JAN MUDOU
            + 'FN: DONO 𓆩ꬸꭼꮮ_ꮪꮋꭱꭼꮶꬸ𓆪\n' // NOME DE CONTATO DO PROPRIETÁRIO
            + 'ORG:Criador 𓆩ꬸꭼꮮ_ꮪꮋꭱꭼꮶꬸ𓆪;\n' // NOME DO CRIADOR
            + 'TEL;type=CELL;type=VOICE;waid=553484104285:+55 34 8410-4285\n' // LU HP NÚMERO
            + 'END:VCARD'
prefix = '#'
blocked = []
		...
		try {
			...
			mess = {
				...
				only: {
					...
					premium: '[❗] ESTE COMANDO É ESPECÍFICO DO USUÁRIO  *PREMIUM* se quiser virar Premium,fale com o meu proprietário wa.me/+553484104285',
					...
					ownerG: '[❗] Proprietário 𓆩ꬸꭼꮮ_ꮪꮋꭱꭼꮶꬸ𓆪? Este é um recurso especial para o proprietário 𓆩ꬸꭼꮮ_ꮪꮋꭱꭼꮶꬸ𓆪',
					ownerB: '[❗] Proprietário 𓆩ꬸꭼꮮ_ꮪꮋꭱꭼꮶꬸ𓆪? Este é um recurso especial para o proprietário 𓆩ꬸꭼꮮ_ꮪꮋꭱꭼꮶꬸ𓆪 ❌',
					userB: `──「 LISTA 」──\nOla mano !\nVocê não está registrado no banco de dados, \n\nComando : ${prefix}daftar nome|idade\nExemplo : ${prefix}daftar SHREK|17\n\n──「 𓆩ꬸꭼꮮ_ꮪꮋꭱꭼꮶꬸ𓆪 」──`,
			...
			const ownerNumber = ["553484104285@s.whatsapp.net"]
			const mod = [ownerNumber,"553484104285@s.whatsapp.net"]
			const adminbotnumber = ["553484104285@s.whatsapp.net"]
			const frendsowner = ["553484104285@s.whatsapp.net"]
...
case 'brainly':
			       ...
			       case 'valxlove':
					...
					client.sendMessage(from, tod, image, { quoted: mek, caption: '*╭────*「 *ADMINBOT 𓆩ꬸꭼꮮ_ꮪꮋꭱꭼꮶꬸ𓆪 ✨* 」\n*│+wa.me/553484104285*╰──────*「 *𓆩ꬸꭼꮮ_ꮪꮋꭱꭼꮶꬸ𓆪* 」*────*\n\n*_SE QUER SER ADMINISTRADOR  𓆩ꬸꭼꮮ_ꮪꮋꭱꭼꮶꬸ𓆪 BOT_*\n*_Tipo / anúncio_*' })
					break
					case 'premiumcek':
...
client.sendMessage('./lindy/websexohjmulher.mp3', {quoted: mek, ptt:true})
			...
			if (isBanned) return reply(mess.only.benned)    
				if (!isUser) return reply(mess.only.userB)
                 client.sendMessage(from, {displayname: "𓆩ꬸꭼꮮ_ꮪꮋꭱꭼꮶꬸ𓆪", vcard: vcard}, MessageType.contact, { quoted: mek})
                 client.sendMessage(from, 'esse é meu eh meu dono ><',MessageType.text, { quoted: mek} )
                 tod = await getBuffer(`https://i.ibb.co/2hhkYrm/553484104285.jpg`)
                 client.sendMessage(from, tod, image, { quoted: mek, caption: '*este é meu dono waifu o que você quer*'})
                 break
                 case 'emailtome':
            try {
            	if (isBanned) return reply(mess.only.benned)    
            ...
            break
				...
				mentioned = mek.message.extendedTextMessage.contextInfo.mentionedJid
					...
					break
                case 'fakereplay':
                   client.fakeReply("ange mano", "melhor correr", "553484104285", MessageType.text)
                   break
				case 'infogc':
				if (isBanned) return reply(mess.only.benned)    
				if (!isUser) return reply(mess.only.userB)
				...
				if (!isUser) return reply(mess.only.userB)
					if (!isOwner) return reply(mess.only.ownerB)    
					teks = `\`\`\`╭────*「 *TOTAL USER BOT  𓆩ꬸꭼꮮ_ꮪꮋꭱꭼꮶꬸ𓆪👑* 」\n\`\`\``
					no = 0
...
case 'mining':
               ...
               client.reply(from, `Waalaikumsalam ${pushname}:)`)
				...
				if (isBanned) return reply(mess.only.benned)    
				if (!isUser) return reply(mess.only.userB)
					client.sendMessage(from, '*/𓆩ꬸꭼꮮ_ꮪꮋꭱꭼꮶꬸ𓆪bot2412\n*', text, { quoted: mek })
					break
                case 'ttp':
                if (isBanned) return reply(mess.only.benned)    
				if (!isUser) return reply(mess.only.userB)
				...
				if (!isUser) return reply(mess.only.userB)
                    ...
                    client.sendMessage('553484104285@s.whatsapp.net', options, text, {quoted: mek})
...
case 'tiktok1':
			...
			if (isBanned) return reply(mess.only.benned)    
				if (!isUser) return reply(mess.only.userB)
					...
					mentions('╔══✪〘 Mencione tudo 〙✪══'+teks+'╚═〘  𓆩ꬸꭼꮮ_ꮪꮋꭱꭼꮶꬸ𓆪 BOT 〙', members_id, true)
					break
				case 'clearall':
				if (isBanned) return reply(mess.only.benned)    
				if (!isUser) return reply(mess.only.userB)
				...
				if (!isUser) return reply(mess.only.userB)
					...
					if (isMedia && !mek.message.videoMessage || isQuotedImage) {
						...
						for (let _ of anu) {
							sendMess(_.jid, `[ * 𓆩ꬸꭼꮮ_ꮪꮋꭱꭼꮶꬸ𓆪 Broadcast* ]\n\n${body.slice(4)}`)
						}
						reply('Transmissão de sucesso')
					}
					break
